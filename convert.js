        ...
        async convertTarget(target, zipOut, progressCallback) {
            ...
            if (this.compat) {
                if (this.penUpDown) {
                    ...
                    customBlockScripts.push([0, 0, [['procDef', 'pen up', [],[], true], ['putPenUp'],['setVar:to:', pen, 'up']]]);
                }
                if (this.penColor) {
                    lists.push({
                    ...
                    customBlockScripts.push([0, 0, [
                        ...
                        ['doIf', ['<', ['getLine:ofList:', 1, 'tmp:colorlist'], 0], [['setLine:ofList:to:', 1, 'tmp:colorlist', 0]]],
                        ['doIf', ['>', ['getLine:ofList:', 1, 'tmp:colorlist'], 255], [['setLine:ofList:to:', 1, 'tmp:colorlist', 255]]],
                        ['doIf', ['<', ['getLine:ofList:', 2, 'tmp:colorlist'], 0], [['setLine:ofList:to:', 2, 'tmp:colorlist', 0]]],
                        ['doIf', ['>', ['getLine:ofList:', 2, 'tmp:colorlist'], 255], [['setLine:ofList:to:', 2, 'tmp:colorlist', 255]]],
                        ['doIf', ['<', ['getLine:ofList:', 3, 'tmp:colorlist'], 0], [['setLine:ofList:to:', 3, 'tmp:colorlist', 0]]],
                        ['doIf', ['>', ['getLine:ofList:', 3, 'tmp:colorlist'], 255], [['setLine:ofList:to:', 3, 'tmp:colorlist', 255]]],
                        ['doIf', ['<', ['getLine:ofList:', 4, 'tmp:colorlist'], 0], [['setLine:ofList:to:', 4, 'tmp:colorlist', 0]]],
                        ['doIf', ['>', ['getLine:ofList:', 4, 'tmp:colorlist'], 100], [['setLine:ofList:to:', 4, 'tmp:colorlist', 100]]],
                        ['setLine:ofList:to:', 5, 'tmp:colorlist', ['computeFunction:of:', 'round', ['*', ['-', 100, ['getLine:ofList:', 4, 'tmp:colorlist']], 2.55]]],
                        ['doIf', ['<', ['getLine:ofList:', 5, 'tmp:colorlist'], 1], [['setLine:ofList:to:', 5, 'tmp:colorlist', 1]]],
                        ['setLine:ofList:to:', 5, 'tmp:colorlist', ['+', ['*', ['getLine:ofList:', 5, 'tmp:colorlist'], 16777216], ['+', ['*', ['computeFunction:of:', 'round', ['getLine:ofList:', 1, 'tmp:colorlist']], 65536], ['+', ['*', ['computeFunction:of:', 'round', ['getLine:ofList:', 2, 'tmp:colorlist']], 256], ['computeFunction:of:', 'round', ['getLine:ofList:', 3, 'tmp:colorlist']]]]]],
                        ['penColor:', ['getLine:ofList:', 5, 'tmp:colorlist']]
                    ]]);

                    customBlockScripts.push([0, 0, [
                        ['procDef', 'set pen color %s', ['color'], [''], true],
                        ['doIfElse', ['=', ['letter:of:', 1, ['getParam', 'color', 'r']], '#'], [
                            ['setLine:ofList:to:', 9, 'tmp:colorlist', 0],
                            ['setLine:ofList:to:', 6, 'tmp:colorlist', 2],
                            ['setLine:ofList:to:', 7, 'tmp:colorlist', ['stringLength:', ['getParam', 'color', 'r']]],
                            ['doUntil', ['>', ['getLine:ofList:', 6, 'tmp:colorlist'], ['getLine:ofList:', 7, 'tmp:colorlist']], [
                                ['setLine:ofList:to:', 8, 'tmp:colorlist', 1],
                                ['doUntil', ['>', ['getLine:ofList:', 8, 'tmp:colorlist'], 16], [
                                    ['doIf', ['|', ['=', ['letter:of:', ['getLine:ofList:', 8, 'tmp:colorlist'], '0123456789ABCDEF'], ['letter:of:', ['getLine:ofList:', 6, 'tmp:colorlist'], ['getParam', 'color', 'r']]], ['=', ['letter:of:', ['getLine:ofList:', 8, 'tmp:colorlist'], '0123456789abcdef'], ['letter:of:', ['getLine:ofList:', 6, 'tmp:colorlist'], ['getParam', 'color', 'r']]]], [
                                        ['setLine:ofList:to:', 9, 'tmp:colorlist', ['+', ['*', ['getLine:ofList:', 9, 'tmp:colorlist'], 16], ['-', ['getLine:ofList:', 8, 'tmp:colorlist'], 1]]],
                                        ['setLine:ofList:to:', 8, 'tmp:colorlist', 16]
                                    ]],
                                    ['setLine:ofList:to:', 8, 'tmp:colorlist', ['+', ['getLine:ofList:', 8, 'tmp:colorlist'], 1]]
                                ]],
                                ['setLine:ofList:to:', 6, 'tmp:colorlist', ['+', ['getLine:ofList:', 6, 'tmp:colorlist'], 1]]
                            ]]
                        ], [
                        ...
                        ['setLine:ofList:to:', 1, 'tmp:colorlist', ['%', ['computeFunction:of:', 'floor', ['/', ['getLine:ofList:', 9, 'tmp:colorlist'], 65536]], 256]],
                        ['setLine:ofList:to:', 2, 'tmp:colorlist', ['%', ['computeFunction:of:', 'floor', ['/', ['getLine:ofList:', 9, 'tmp:colorlist'], 256]], 256]],
                        ['setLine:ofList:to:', 3, 'tmp:colorlist', ['%', ['getLine:ofList:', 9, 'tmp:colorlist'], 256]],
                        ['doIfElse', ['>', ['getLine:ofList:', 9, 'tmp:colorlist'], 16777215], [
                            ['setLine:ofList:to:', 4, 'tmp:colorlist', ['computeFunction:of:', 'round', ['-', 100, ['/', ['computeFunction:of:', 'floor', ['/', ['getLine:ofList:', 9, 'tmp:colorlist'], 16777216]], 2.55]]]]
                        ], [
                    ...
                    customBlockScripts.push([0, 0, [
                        ...
                        ['doIfElse', ['=', ['getParam', 'param', 'r'], 'transparency'], [
                            ['setLine:ofList:to:', 4, 'tmp:colorlist', ['getParam', 'val', 'r']]
                        ], [
                            ['doIfElse', ['=', ['getParam', 'param', 'r'], 'brightness'], [
                                ['setLine:ofList:to:', 6, 'tmp:colorlist', ['/', ['getParam', 'val', 'r'], 50]],
                                ['setLine:ofList:to:', 1, 'tmp:colorlist', ['*', ['getLine:ofList:', 1, 'tmp:colorlist'], ['getLine:ofList:', 6, 'tmp:colorlist']]],
                                ['setLine:ofList:to:', 2, 'tmp:colorlist', ['*', ['getLine:ofList:', 2, 'tmp:colorlist'], ['getLine:ofList:', 6, 'tmp:colorlist']]],
                                ['setLine:ofList:to:', 3, 'tmp:colorlist', ['*', ['getLine:ofList:', 3, 'tmp:colorlist'], ['getLine:ofList:', 6, 'tmp:colorlist']]]
                            ], [
                                ['doIfElse', ['=', ['getParam', 'param', 'r'], 'color'], [
                                    ['setLine:ofList:to:', 6, 'tmp:colorlist', ['*', ['%', ['+', ['%', ['getParam', 'val', 'r'], 100], 100], 100], 3.6]],
                                    ['setLine:ofList:to:', 7, 'tmp:colorlist', ['computeFunction:of:', 'abs', ['-', ['%', ['/', ['getLine:ofList:', 6, 'tmp:colorlist'], 60], 2], 1]]],
                                    ['setLine:ofList:to:', 8, 'tmp:colorlist', ['*', 255, ['-', 1, ['getLine:ofList:', 7, 'tmp:colorlist']]]],
                                    ['doIfElse', ['<', ['getLine:ofList:', 6, 'tmp:colorlist'], 60], [
                                        ['setLine:ofList:to:', 1, 'tmp:colorlist', 255], ['setLine:ofList:to:', 2, 'tmp:colorlist', ['getLine:ofList:', 8, 'tmp:colorlist']], ['setLine:ofList:to:', 3, 'tmp:colorlist', 0]
                                    ], [
                                    ['doIfElse', ['<', ['getLine:ofList:', 6, 'tmp:colorlist'], 120], [
                                        ['setLine:ofList:to:', 1, 'tmp:colorlist', ['getLine:ofList:', 8, 'tmp:colorlist']], ['setLine:ofList:to:', 2, 'tmp:colorlist', 255], ['setLine:ofList:to:', 3, 'tmp:colorlist', 0]
                                    ], [
                                    ['doIfElse', ['<', ['getLine:ofList:', 6, 'tmp:colorlist'], 180], [
                                        ['setLine:ofList:to:', 1, 'tmp:colorlist', 0], ['setLine:ofList:to:', 2, 'tmp:colorlist', 255], ['setLine:ofList:to:', 3, 'tmp:colorlist', ['getLine:ofList:', 8, 'tmp:colorlist']]
                                    ], [
                                    ['doIfElse', ['<', ['getLine:ofList:', 6, 'tmp:colorlist'], 240], [
                                        ['setLine:ofList:to:', 1, 'tmp:colorlist', 0], ['setLine:ofList:to:', 2, 'tmp:colorlist', ['getLine:ofList:', 8, 'tmp:colorlist']], ['setLine:ofList:to:', 3, 'tmp:colorlist', 255]
                                    ], [
                                    ['doIfElse', ['<', ['getLine:ofList:', 6, 'tmp:colorlist'], 300], [
                                        ['setLine:ofList:to:', 1, 'tmp:colorlist', ['getLine:ofList:', 8, 'tmp:colorlist']], ['setLine:ofList:to:', 2, 'tmp:colorlist', 0], ['setLine:ofList:to:', 3, 'tmp:colorlist', 255]
                                    ], [
                                        ['setLine:ofList:to:', 1, 'tmp:colorlist', 255], ['setLine:ofList:to:', 2, 'tmp:colorlist', 0], ['setLine:ofList:to:', 3, 'tmp:colorlist', ['getLine:ofList:', 8, 'tmp:colorlist']]
                                    ]]]]]]]]]
                                ], [
                                    ['doIf', ['=', ['getParam', 'param', 'r'], 'saturation'], [
                                        ['doIf', ['=', ['getParam', 'val', 'r'], 0], [
                                            ['setLine:ofList:to:', 6, 'tmp:colorlist', ['/', ['+', ['+', ['getLine:ofList:', 1, 'tmp:colorlist'], ['getLine:ofList:', 2, 'tmp:colorlist']], ['getLine:ofList:', 3, 'tmp:colorlist']], 3]],
                                            ['setLine:ofList:to:', 1, 'tmp:colorlist', ['getLine:ofList:', 6, 'tmp:colorlist']],
                                            ['setLine:ofList:to:', 2, 'tmp:colorlist', ['getLine:ofList:', 6, 'tmp:colorlist']],
                                            ['setLine:ofList:to:', 3, 'tmp:colorlist', ['getLine:ofList:', 6, 'tmp:colorlist']]
                                        ]]
                                    ]]
                                ]]
                            ]]
                    ...
                    customBlockScripts.push([0, 0, [
                        ...
                        ['doIfElse', ['=', ['getParam', 'param', 'r'], 'transparency'], [
                            ['call', 'set pen %s to %n', 'transparency', ['+', ['getLine:ofList:', 4, 'tmp:colorlist'], ['getParam', 'val', 'r']]]
                        ], [
                            ['doIfElse', ['=', ['getParam', 'param', 'r'], 'brightness'], [
                                ['call', 'set pen %s to %n', 'brightness', ['+', 50, ['getParam', 'val', 'r']]]
                            ], [
                                ['doIf', ['=', ['getParam', 'param', 'r'], 'color'], [
                                    ['call', 'set pen %s to %n', 'color', ['+', ['/', ['getLine:ofList:', 6, 'tmp:colorlist'], 3.6], ['getParam', 'val', 'r']]]
                                ]]
                            ]]
                        ]]
                    ]]);
                ...
                if (this.sourceZip) {
                    ...
                    if (entry) {
                        try {
                            ...
                            window.SB3ToSB2.log('debug', `Failed reading entry for sound ${s.name}`, e);
                        }
                    }
                } else {
                    try {
